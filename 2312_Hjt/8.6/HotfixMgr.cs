...
public class HotfixMgr : MonoBehaviour
{
    ...
    /// 资源服务器的地址(Https://)
    /// </summary>
    string res_Sever_Url = "http://127.0.0.1/Demo8.5/";
    //资源服务器的游戏版本号
    ...
    void Game_Hotfix_Res_DownLoad()
    {
        ...
        StartCoroutine(DownLoad_Url_To_Local(resList_Config_Path, (data) =>
        {
            ...
            string local_ResList_ConfigStr = File.ReadAllText(Application.persistentDataPath + "/ResList_Config.txt");
